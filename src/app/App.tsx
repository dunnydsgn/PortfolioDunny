...
import svgPaths from "@/imports/Home/svg-ds3qma5far";

// ── Image imports ──────────────────────────────────────────────────────────────
import imgFooterLogo from "@/imports/Home/f54ac1fc19bb08d07586a1d50537950f5dcd3093.png";
import imgNoise from "@/imports/Home/3365021da70d4555ce147b5cabc4c900f7308661.png";
import imgTemplatePPT from "@/imports/Home/d9956c0045e919d7d8e9725f3aac7ddaf3cb423b.png";
import imgBrechoPeachy from "@/imports/Home/837b9f4a81cb65d419e4c84cedf0249795d377e6.png";
import imgLyricsBook from "@/imports/Home/19b4994e3242818be803ca618e6ffef527ac46bd.png";
import imgEbacPods from "@/imports/Home/2d31e2ea6e21354a3a3d724a398007da6a30af8b.png";
import imgSupersticao from "@/imports/Home/8fbba76cc324875c05269e5de8436a837e8a8869.png";
import imgPptPalestra from "@/imports/Home/78a568c923086e3064f9d7dcdee327e919a5e325.png";
import imgBackdrop from "@/imports/Home/dce4136f38bceed7aef66f551ebfb3e9bf370b15.png";
import imgHeroBg from "@/imports/Home/b8dc61aff71dcf861c9a43a0a5bb39ebc529476d.png";
import imgHeaderLogo from "@/imports/Home/530ba864da046f1c49ea097b67753c784ff1c2ca.png";
...
function VejaMaisButton({ href }: { href: string }) {
  return (
    <a
      ...
      style={{
        boxShadow:
          "0 0 9.5px rgba(162,45,247,0.12), 0 0 23px rgba(162,45,247,0.1), 0 0 6.5px rgba(162,45,247,0.1)",
      }}
    >
      <span className="absolute inset-0 border border-[#8338ec] rounded-full pointer-events-none" />
      <span className="text-[#e9deff] text-sm tracking-[-0.01em] uppercase font-medium">
        Veja mais
      </span>
      <ButtonArrow />
    </a>
...
// Shared card glow: purple radial burst at top-left, noise overlay
function CardGlow({ cyan = false }: { cyan?: boolean }) {
  const color1 = cyan ? "rgba(165,239,255,1)" : "rgba(210,165,255,1)";
  const color2 = cyan ? "rgba(110,191,244,0.22)" : "rgba(177,110,244,0.22)";
  return (
    <span
      aria-hidden
    ...
    >
      <span
        ...
        style={{
          background: `radial-gradient(ellipse 55% 70% at 15% 20%, ${color1} 0%, ${color2} 77%, transparent 100%)`,
          opacity: 0.2,
        }}
      />
      <span
    ...
    <header className="sticky top-0 z-50 px-4 md:px-10">
      <div className="relative bg-[#270f2e] border-b-2 border-l-2 border-r-2 border-[#98f9ff] rounded-bl-[35px] rounded-br-[35px]">
        <div className="flex items-center justify-between px-6 md:px-10 h-[80px] md:h-[100px]">
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden text-[#f3f1eb] p-1 -mr-1"
            onClick={() => setOpen((v) => !v)}
...
// ── Hero + About (one connected block) ────────────────────────────────────────
function HeroAndAbout() {
  return (
    <section className="mx-4 md:mx-10 mt-3">

      {/* ── Hero panel ── rounded top corners, cyan 3-sided border */}
      <div className="relative rounded-tl-[35px] rounded-tr-[35px] overflow-hidden border-t-2 border-l-2 border-r-2 border-[#98f9ff] min-h-[420px] md:min-h-[535px]">
        ...
        {/* Left gradient scrim — keeps text legible on all viewports */}
        <span
          aria-hidden
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <a
              href="https://wa.me/message/NDCJUMKWIGRDD1"
              target="_blank"
              rel="noopener noreferrer"
      ...
      {/* ── About panel ── flush below hero, shares same outer column */}
      <motion.div
        variants={fadeUp}
        initial="hidden"
        whileInView="visible"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-[360px] md:min-h-[533px]">
        ...
        {/* ── Text column — fixed width, generous internal padding ── */}
    ...
    >
      <div className="bg-[#6717a4] rounded-tl-[34px] rounded-tr-[34px] flex flex-col items-center py-10 md:py-16 gap-8">
        ...
        <div className="flex items-center gap-5">
          {/* Email */}
          <a
            href="mailto:dunnydsgn@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/dunnydsgn"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:opacity-70 transition-opacity"
...
const projects: Project[] = [
  {
    ...
    tags: ["Design Gráfico"],
    description:
      "Design de backdrop e comunicação visual para o Palco Humanare no Rio Innovation Week 2026, alinhando presença de marca e cenografia para grandes eventos.",
    image: imgBackdrop,
  },
  {
    ...
    tags: ["Design Gráfico"],
    description:
      "Identidade visual e design de slides para apresentação em palco no formato TEDx. Foco em storytelling visual, sintetizando ideias complexas com minimalismo e clareza.",
  ...
  },
  {
    ...
    description:
      "Projeto de intervenção urbana e design digital que explora a cultura brasileira através das superstições, unindo a estética de lambe-lambes a uma plataforma interativa.",
  ...
  },
  {
    ...
    description:
      "Aplicativo de áudio focado em podcasts educacionais, desenhado para transformar a escuta passiva em uma experiência de aprendizado ativa, fluida e organizada.",
    image: imgEbacPods,
  },
  {
    category: "PROJETO ACADÊMICO",
    ...
    description:
      "Projeto de design editorial e experimentação tipográfica que traduz a poética e o universo visual das músicas do Jão para o formato impresso.",
    image: imgLyricsBook,
  ...
  },
  {
    ...
    description:
      "Layout estratégico e profissional criado para padronizar o envio de orçamentos. Unificação da identidade visual da marca com um design claro, elegante e de alto impacto de conversão.",
